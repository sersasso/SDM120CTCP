...
/*
 * sdm120c: ModBus TCP client to read EASTRON SDM120C smart mini power meter registers
 *
 * Copyright (C)
 * 
 * fully based on SDM120C by Gianfranco Di Prinzio <gianfrdp@inwind.it>
...
//	ctx = modbus_new_tcp("192.168.1.5", 8899);
      ctx = modbus_new_tcp_pi("ew11", "8899");
    if (ctx == NULL) {
